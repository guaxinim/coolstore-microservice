    ...
    public void configure() throws Exception {
        ...
        from("direct:inventory")
            ...
            .hystrix().id("Inventory Service")
                ...
                .setBody(simple("null"))
                .removeHeaders("CamelHttp*")
                .recipientList(simple("http4://inventory:8080/api/availability/${header.itemId}")).end()
            .onFallback()
                //.setHeader(Exchange.HTTP_RESPONSE_CODE, constant(Response.Status.SERVICE_UNAVAILABLE.getStatusCode()))
        ...
        from("direct:rating")
                ...
                .setHeader(Exchange.HTTP_URI, simple("http://rating:8080/api/rating/${header.itemId}"))
